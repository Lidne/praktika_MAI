...
// NewProductPostgresRepo productPostgresRepo constructor
func NewProductPostgresRepo(dbpool *pgxpool.Pool) *productPostgresRepo {
	return &productPostgresRepo{dbpool: dbpool}
}

// Create new product
func (p *productPostgresRepo) Create(ctx context.Context, product *models.Product) (*models.Product, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "productPostgresRepo.Create")
	defer span.Finish()
...
func (p *productPostgresRepo) Update(ctx context.Context, product *models.Product) (*models.Product, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "productPostgresRepo.Update")
	defer span.Finish()
...
func (p *productPostgresRepo) GetByID(ctx context.Context, productID primitive.ObjectID) (*models.Product, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "productPostgresRepo.GetByID")
	defer span.Finish()
...
func (p *productPostgresRepo) Search(ctx context.Context, search string, pagination *utils.Pagination) (*models.ProductsList, error) {
	span, ctx := opentracing.StartSpanFromContext(ctx, "productPostgresRepo.Search")
	defer span.Finish()
